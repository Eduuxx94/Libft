...
#    Updated: 2022/01/21 18:12:47 by ede-alme         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE = ft_isalnum.c ft_isprint.c ft_memcmp.c\
...
#ft_putnbr_fd.c ft_itoa.c ft_putendl_fd.c ft_putchar_fd.c  ft_split.c
#ft_substr.c
OBJ = $(SOURCE:.c=.o)			
